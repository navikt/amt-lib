...
class FinnGjeldendeDeltakelsesmengderTest {
    @Test
    fun `finnGjeldendeDeltakelsesmengder - kun vedtak - returnerer riktig perioder`() {
        val vedtak = TestData.lagVedtak(fattet = LocalDateTime.now())
        val historikk = TestData.lagDeltakerHistorikk(listOf(vedtak))

        val perioder = finnGjeldendeDeltakelsesmengder(historikk)
    ...
    @Test
    fun `finnGjeldendeDeltakelsesmengder - ingen overlappende endringer`() {
    ...
    @Test
    fun `finnGjeldendeDeltakelsesmengder - med flere overlappende endringer`() {
    ...
    @Test
    fun `finnGjeldendeDeltakelsesmengder - en overlappende endring`() {
    ...
    @Test
    fun `finnGjeldendeDeltakelsesmengder - nyeste overlappende endring benyttes`() {
        val endringer = listOf(
            TestData.lagEndreDeltakelsesmengde(
                deltakelsesprosent = 80,
                gyldigFra = "2024-01-10".toDate(),
    ...
    @Test
    fun `finnGjeldendeDeltakelsesmengder - flere endringer på samme dato, siste benyttes`() {
        val endringer = listOf(
            TestData.lagEndreDeltakelsesmengde(
                deltakelsesprosent = 70,
                gyldigFra = "2024-01-10".toDate(),

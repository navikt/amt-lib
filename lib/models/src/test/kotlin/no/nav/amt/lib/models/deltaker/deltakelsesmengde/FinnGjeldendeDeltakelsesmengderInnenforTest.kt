...
class FinnGjeldendeDeltakelsesmengderInnenforTest {
    @Test
    fun `finnGjeldendeDeltakelsesmengderInnenfor - kun vedtak - returnerer riktig perioder`() {
        ...
        val perioder = finnGjeldendeDeltakelsesmengderInnenfor(historikk, fraDato, tilDato)
    ...
    @Test
    fun `finnGjeldendeDeltakelsesmengder - kun importert fra arena - returnerer riktig perioder`() {
    ...
    @Test
    fun `finnGjeldendeDeltakelsesmengderInnenfor - vedtak og endring - returnerer riktig perioder`() {
        val fraDato = "2024-01-01".toDate()
        val tilDato = "2024-01-31".toDate()
    ...
    @Test
    fun `finnGjeldendeDeltakelsesmengderInnenfor - vedtak og endring samme dato - returnerer riktig periode`() {
        val fraDato = "2024-01-01".toDate()
        val tilDato = "2024-01-31".toDate()
    ...
    @Test
    fun `finnGjeldendeDeltakelsesmengderInnenfor - flere gyldige og ugyldige endringer - returnerer riktig periode`() {
    ...
    @Test
    fun `finnGjeldendeDeltakelsesmengderInnenfor - tilDato er null - returnerer riktig periode`() {
        val fraDato = "2024-01-01".toDate()
        val tilDato = null
    ...
    @Test
    fun `finnGjeldendeDeltakelsesmengderInnenfor - flere endringer med samme gyldigFra - returnerer riktig periode`() {
        val fraDato = "2024-01-01".toDate()
        val tilDato = "2024-01-31".toDate()
